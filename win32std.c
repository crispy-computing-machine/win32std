...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_res_get, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	ZEND_ARG_TYPE_MASK(0, res_rc, IS_RESOURCE, 0)
	ZEND_ARG_TYPE_MASK(0, type, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, name, IS_STRING, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_res_set, 0, 1, _IS_BOOL)
	...
	ZEND_ARG_TYPE_MASK(0, type, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, name, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, data, IS_LONG, 0)
ZEND_END_ARG_INFO()

//function win_play_wav(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_play_wav, 0, 1, _IS_BOOL)
	ZEND_ARG_TYPE_MASK(0, file, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, loop, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

//function win_beep(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_beep, 0, 1, _IS_BOOL)
	ZEND_ARG_TYPE_MASK(0, str, IS_STRING, 0)
ZEND_END_ARG_INFO()

//function win_message_box(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_message_box, 0, 1, IS_LONG)
	ZEND_ARG_TYPE_MASK(0, text, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, type, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, caption, IS_STRING, 0)
ZEND_END_ARG_INFO()

//function win_create_link(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_create_link, 0, 1, _IS_BOOL)
	ZEND_ARG_TYPE_MASK(0, file, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, link, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, args, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, descr, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, workingdir, IS_STRING, 0)
ZEND_END_ARG_INFO()

//function win_browse_folder(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_browse_folder, 0, 1, IS_STRING)
	ZEND_ARG_TYPE_MASK(0, dir, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, caption, IS_STRING, 0)
ZEND_END_ARG_INFO()

//function win_browse_file(){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_win_browse_file, 0, 1, MAY_BE_STRING|MAY_BE_NULL)
	ZEND_ARG_TYPE_MASK(0, open, IS_LONG, 0)
	ZEND_ARG_TYPE_MASK(0, path, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, file, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, ext, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, zfilter, MAY_BE_STRING|MAY_BE_ARRAY, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_res_exists, 0, 1, _IS_BOOL)
	ZEND_ARG_TYPE_MASK(0, type, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, name, IS_STRING, 0)
	ZEND_ARG_TYPE_MASK(0, lang, IS_LONG, 0)
ZEND_END_ARG_INFO()
