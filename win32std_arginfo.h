...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_res_close, 0, 1, _IS_BOOL)
ZEND_END_ARG_INFO()

// function res_set($module, $type, $name, $data){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_res_set, 0, 4, _IS_BOOL)
ZEND_END_ARG_INFO()

// function win_play_wav($file, $loop){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_win_play_wav, 0, 2, _IS_BOOL)
ZEND_END_ARG_INFO()

// function win_beep($str){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_win_beep, 0, 1, _IS_BOOL)
ZEND_END_ARG_INFO()

// function win_message_box($text, $type, $caption){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_win_message_box, 0, 3, IS_LONG)
ZEND_END_ARG_INFO()

// function win_create_link($file, $link, $args, $descr, $workingdir){}
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_win_create_link, 0, 5, _IS_BOOL)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_res_exists, 0, 3, _IS_BOOL)
ZEND_END_ARG_INFO()